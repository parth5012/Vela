...
if DATABASE_URL.startswith("sqlite"):
    ...
    sqlite_tables = [
        ...
        for name in ["conversations", "oauth_tokens", "experiences", "system_prompt_fragments", "skills_registry", "tool_invocations", "sync_messages", "system_settings", "briefings", "check_ins"]
    ]
